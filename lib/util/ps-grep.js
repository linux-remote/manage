...
let mainProcessMark, serverProcessMark, userServerProcessMark;
if(process.env.NODE_ENV === 'debug'){
  mainProcessMark = path.join(__dirname, '../../../server/src/index.js');
  serverProcessMark = 'server_main/src/index.js';
  userServerProcessMark = 'server_user/src/index.js';
} else {
  mainProcessMark = homeDir + '/index.js';
  serverProcessMark = getFullMName('server_main') + '/src/index.js';
  userServerProcessMark = getFullMName('server_user') + '/src/index.js';
}
